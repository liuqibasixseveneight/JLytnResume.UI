...
//         float strengthFactor = 0.025 * uBrushStrength;

//         float falloff = exp(-brushSizeFactor * q * q);
//         falloff = pow(falloff, 0.4);

//         me.xyw += strengthFactor * falloff * vec3(m, 8.0);

//         if (velMagnitude < 10.0) {
//           float distToCursor = length(U - mousePos);
//           float influence = exp(-distToCursor * 0.003);
...
//     mixer1 = clamp(mixer1 + rippleWave * 0.4, 0.0, 1.0);
//     mixer2 = clamp(mixer2 + rippleWave * 0.3, 0.0, 1.0);
//     mixer3 = clamp(mixer3 + rippleWave * 0.2, 0.0, 1.0);

//     vec3 col = uColor1;
//     col = mix(col, uColor2, mixer1);
//     col = mix(col, uColor3, mixer2);
//     col = mix(col, uColor4, mixer3);
//     col = mix(col, uColor5, mixer1 * 0.5 + mixer2 * 0.5);
//     col = mix(col, uColor6, mixer2 * 0.6 + mixer3 * 0.4);
//     col = mix(col, uColor7, mixer1 * 0.7 + mixer3 * 0.3);
//     col = mix(col, uColor8, mixer1 * 0.3 + mixer2 * 0.7);
//     col *= uColorIntensity;
...
//       me.xy *= uFluidDecay * (0.8 + 0.2*sin(iTime*0.7 + length(v)));
//       me.z *= uTrailLength * (0.9 + 0.1*cos(iTime*0.3));
...
//     // mixers with added noise for iridescence
//     float noise = sin(uv.x*10.0 + iTime*0.8) * cos(uv.y*12.0 - iTime*0.6);
//     float mixer1 = clamp(cos(uv.x * d) * 0.5 + 0.5 + 0.1*noise, 0.0, 1.0);
//     float mixer2 = clamp(cos(uv.y * a) * 0.5 + 0.5 + 0.08*noise, 0.0, 1.0);
//     float mixer3 = clamp(sin(d + a) * 0.5 + 0.5 + 0.05*noise, 0.0, 1.0);
...
//     vec3 col = uColor1;
//     col = mix(col, uColor2, pow(mixer1, 1.5));
//     col = mix(col, uColor3, pow(mixer2, 2.0));
//     col = mix(col, uColor4, pow(mixer3, 1.2));
//     col = mix(col, uColor5, clamp(mixer1*0.5 + mixer2*0.5 + 0.05*sin(iTime*0.3), 0.0, 1.0));
//     col = mix(col, uColor6, clamp(mixer2*0.6 + mixer3*0.4 + 0.05*cos(iTime*0.5), 0.0, 1.0));
//     col = mix(col, uColor7, clamp(mixer1*0.7 + mixer3*0.3 + 0.05*sin(iTime*0.7), 0.0, 1.0));
//     col = mix(col, uColor8, clamp(mixer1*0.3 + mixer2*0.7 + 0.05*cos(iTime*0.6), 0.0, 1.0));
